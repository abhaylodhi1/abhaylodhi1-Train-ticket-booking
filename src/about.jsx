...
const trainBanner = "/assets/banner/train.png";
const viewPageButton = "/assets/buttons/View page.png";
const about1 = "/assets/banner/about1.png";
const about2 = "/assets/banner/about2.png";
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-black py-6 px-4 md:px-24">
        ...
        <div className="text-left md:px-12 py-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-black py-6 px-4 md:px-24">
        <div className="text-left md:px-12 py-6">
          ...
          <p className="text-lg md:text-2xl text-white mt-4">
            Van Lang Tour is a dedicated online platform designed to revolutionize the way you embark on train journeys. 
            Whether you're a first-time traveler, a seasoned explorer, or planning a memorable trip with family and friends, 
      ...
      <div className="bg-black px-4 md:px-24 py-6">
        ...
        <p className="text-lg md:text-2xl text-white mt-4 text-center md:text-left">
          Our mission is simple: to provide you with a hassle-free and enjoyable travel experience. 
          We understand that the journey itself is an integral part of your adventure, 
          and that's why we're committed to offering a wide selection of train routes, impeccable service, and competitive prices.
        </p>
      </div>
    </>
  );
