...
const bannerImage = "../src/assets/banner/banner2.png";
const numberSlideImage = "../src/assets/banner/number slide.png";
const nextButtonImage = "../src/assets/buttons/next.png";
